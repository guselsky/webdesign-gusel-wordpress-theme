 ...
 *
 * @uses webdesign_gusel_header_style()
 */
...
add_action( 'after_setup_theme', 'webdesign_gusel_custom_header_setup' );

if ( ! function_exists( 'webdesign_gusel_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see webdesign_gusel_custom_header_setup().
 */
function webdesign_gusel_header_style() {
